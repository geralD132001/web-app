        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="btn-group" role="group" aria-label="">
                    <button type="submit" class="btn btn-success" name="accion" <?php echo ($accion == "Select") ? "disabled" : ""; ?> value="Agregar">Agregar</button>
                </div>
                <div class="btn-group" role="group" aria-label="">
                    <button type="submit" class="btn btn-warning" name="accion" <?php echo ($accion != "Select") ? "disabled" : ""; ?> value="Modificar">Modificar</button>
                </div>
                <div class="btn-group" role="group" aria-label="">
                    <button type="submit" class="btn btn-info" name="accion" <?php echo ($accion != "Select") ? "disabled" : ""; ?> value="Cancelar">Cancelar</button>
                </div>
            </form>
        </div>
